...
const BloodLoss = ({
  ...
  return (
    <WrapperSection>
      <div
        className={`${classHint} shreya eligibility-criteria1 wrapper flex flex-col justify-center items-start w-full relative p-6 py-20 sm:p-20 rounded-rmd z-[25] overflow-hidden`}
